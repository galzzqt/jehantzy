...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">Admin PG Krebet Baru</a>
            ...
            <ul class="navbar-nav navbar-sidenav sidebar-menu" id="exampleAccordion">
                ...
                <li class="sidebar-profile nav-item" data-toggle="tooltip" data-placement="right" title="Admin">
                    <div class="profile-main">
                        <p class="image">
                            <img alt="image" src="images/avatar5.jpg" width="80">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Version">
                    <a class="nav-link" href="">
                        ...
                        <span class="nav-link-text">V-4.0</span>
                    </a>
                </li>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>2024 © PG Krebet Baru</small>
                </div>
            </div>
        </footer>
